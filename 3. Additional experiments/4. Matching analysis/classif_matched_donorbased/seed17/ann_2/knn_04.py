...
from helper_functions import train_clf_and_predict, evaluate_clf, plot_confusion, fixed_select_indices_by_proportion, check_missing_classes_in_folds, match_male_female_donors

adata = match_male_female_donors(adata, covariates=['smoking_status', 'tissue'])
print('sucessfully matched covariates!', flush = True)
...
male_pred, male_true_labels, female_pred, female_true_labels = train_clf_and_predict(embedding, cell_type_labels, sex_labels, individual_labels, prop)
