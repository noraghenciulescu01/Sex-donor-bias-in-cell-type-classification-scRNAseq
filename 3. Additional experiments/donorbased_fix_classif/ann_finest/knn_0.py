...
male_pred, male_true_labels, female_pred, female_true_labels = train_clf_and_predict(embedding, cell_type_labels, sex_labels, individual_labels, prop, Monocyte-derived Mp)
