...
def train_clf_and_predict(X, y, sex_labels, proportion_female, classifier='knn', k = 30):
    '''
    Parameters:
    ...
    X_female_train, X_female_test, y_female_train, y_female_test = train_test_split(
        X_female, y_female, test_size=0.2, stratify=y_female, random_state=60)
    ...
    X_male_train, X_male_test, y_male_train, y_male_test = train_test_split(
        X_male, y_male, test_size=male_proportion, stratify=y_male, random_state=60)
